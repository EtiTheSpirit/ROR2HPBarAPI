...
namespace ROR2HPBarAPI.Data {
	...
	public static class DefaultHealthAndShieldData {
		...
		/// <summary>
		/// The color of the default shield bar.
		/// </summary>
